...
-- 'root@localhost','apples-MacBook-Air.local','8.4.6','2025-09-29 20:36:14'
...
-- Write the SQL Statement for the above Question
select department_id, sum(employee_Id) as total_employees
from employees
group by department_id
...
FROM employees
GROUP BY department_id
HAVING AVG(commission_pct) IS NOT NULL;
